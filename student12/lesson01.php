...
// Prints all items in column:name in table:table12 of database:lesson01
// And adds random entry to table:table12
...
if($result) { // if $result is empty there is no output and no message
  ...
  $val1 = "name".rand();
  $val2 = rand();
  # INSERT INTO `lesson01`.`table12` (`id`, `name`, `description`) VALUES (NULL, 'delta', 'fourth');
  $query = "INSERT INTO `lesson01`.`table12` (`id`, `name`, `description`) VALUES (NULL, '$val1', '$val2')";
