...
function showForm()
{
    return "<!DOCTYPE html><html>
        ...
        <form name='basic' method='Post' action='template.php' onSubmit='return validate();'>
...
{
    echo "<br><form name='basic' method='Post' action='template.php' onSubmit='return validate();'>
