...
function showList($mysqli, $msg)
{
	...
	echo 	'<div class="col-md-12">
			<form action="table02d.php" method="POST">
...
function showInsertForm ()
{
	...
	<form name="basic" method="POST" action="table02d.php" onSubmit="return validate();">
		<table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
			...
			<tr><td>loc_id </td><td><input type="edit" name="loc_id" value="" size="11"></td></tr>
		...
		</table><a href="table02d.php" class="btn btn-primary">Display Database</a></form></div>';
}
...
function showUpdateForm($mysqli) 
{
	...
	if($result = $mysqli->query("SELECT * FROM $usertable WHERE id = $index"))
	{
		while($row = $result->fetch_row())
		{
			echo '	<br>
					<div class="col-md-4">
					<form name="basic" method="POST" action="table02d.php">
						<table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
							...
							<tr><td>loc_id: </td><td><input type="edit" name="loc_id" value="' . $row[2] . '" size="11"></td></tr>
