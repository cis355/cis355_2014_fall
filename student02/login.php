<?php
	...
	if(isset($_POST['loginSubmit']))
	{
		...
		// Create query
		$sql = "SELECT user_id, email, location_id FROM ENA_users WHERE email = ? AND password_hash = ?";
		...
		if($stmt = $mysqli->prepare($sql))
		{
            ...
            if($stmt->execute())
            {
				...
				if ($stmt->fetch())
				{
					...
					if ($_SERVER['HTTP_REFERER'] == "http://cis355.com/student02/login.php" || $_SERVER['HTTP_REFERER'] == "http://www.cis355.com/student02/login.php" )
					{
