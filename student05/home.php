...
<body>
	<div class="col-md-12" style="background-color: black; border-bottom: 2px solid black; box-shadow: 3px 3px 5px #888888;">
		<a href="home.php"><img src="tblogo.jpg" style="margin-top: 5px;"></a>
		<br>
		<br>
	</div>
	...
	<div class="col-md-4" style="margin-top: 40px;">
		...
		<a href="home.php" style="text-decoration: none;"><span class="glyphicon glyphicon-arrow-left" style="padding-right:3px;"></span> Back to Home</a>
