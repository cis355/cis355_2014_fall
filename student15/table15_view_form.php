...
function getMatchingLocation($locations, $camera) {

  foreach($locations as $location) {
    if ($location->location_id == $camera->location_id) {
...
<div class="container-fluid">
  ...
  <form action="table15.php" class="form-horizontal" method="post" role="form">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-2">
        <input name="user_id" type="text" class="required form-control" id="user_id" value="<?php echo $camera->user_id; ?>">
      </div>
    </div>
    <div class="form-group">
      <label for="location_id" class="col-sm-1 control-label">Location</label>
      <div class="col-sm-3">
        <input name="location_id" type="text" class="required form-control" id="location_id" value="<?php echo getMatchingLocation($locations, $camera); ?>">
      </div>
    </div>
    <div class="form-group" id="operation_area" style="display: none">
      <div class="col-sm-8">
        <label class="radio-inline"><input type="radio" name="operation" id="list" value="list" checked></label>
      </div>
    </div>
    <div class="form-group">
      <?php
