<!DOCTYPE html>
<html>
	<head> <!-- making title and linking to bootstrap -->
...
<body>
<?php
//making global var for acessing the database
$hostname="localhost";
$username="user01";
$password="cis355lwip";
$dbname="lwip";
...
if($mysqli)
{
	...
	if($_POST['uid'] != "")
	{
		...
		{
			//populateing each row of table for id = to $index
	...
	//displaying the table if flag is true
	if($dTable)
	{
		displayTable($mysqli);
	}
