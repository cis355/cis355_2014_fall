...
$query37= "CREATE TABLE `lesson01`.`table17` ( `id` INT NOT NULL AUTO_INCREMENT , `name` VARCHAR(20) NOT NULL , `desc` VARCHAR(30) NOT NULL , PRIMARY KEY (`id`) ) ENGINE = InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci";
$result37 = mysql_query($query37);
$val1 = "name".rand();
$val2 = rand();
$query37a = "INSERT INTO `lesson01`.`table17` (`id`, `name`, `desc`) VALUES (NULL, '$val1', '$val2')";
mysql_query($query37);

$query79 = "SELECT * FROM $usertable";
$result79 = mysql_query($query79);
while($row = mysql_fetch_array($result79)){
    $name = $row["$yourfield"];
    echo "Name79: ".$name."<br>"; // generates html code
  }
