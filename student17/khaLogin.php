<?php
	...
	if(isset($_POST['loginSubmit']))
	{
		...
		// Session Information
		$dataID = "1";
		$dataUname = "user1@KittyHavenAdoption.com";
		$dataLocation = "10";
		...
		// Create query
		$sql = "SELECT user_id, email, password_hash, location_id FROM ays_users WHERE email = ? AND password_hash = ?";
	...
	<div class="col-md-4" style="margin-top: 40px;">
		...
		<div class="panel panel-default" style="box-shadow: 2px 2px 7px #888888;">
			<div class="panel-heading"><b>Login</b></div>
				...
				<?php
					echo '<form method="POST" action="khaLogin.php">
					...
					'.$error.'
					<input type="submit" name="loginSubmit" style="width: 100%;" class="btn btn-success">Submit</input>
				</form>';
				?>
				</div>
		</div>
