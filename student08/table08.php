...

{
	...
	echo 	'<div class="col-md-12">
			...
			<h2 style="color: white;">Bikes We Paid For!</h2>

			</td></tr><tr style="font-weight:800; font-size:20px;">

			<td>ID</td><td>Name</td><td>Zip</td>
...

{
	...
	<form name="basic" method="POST" action="table08.php" 
		...
		<table class="table table-condensed" style="border: 1px solid #dddddd; 
			...
			<h2>Bikes Information Form!</h2></td></tr>

			<tr><td>Name: </td><td><input type="edit" name="name" value="" 

			size="20"></td></tr>

			<tr><td>Zip: </td><td><input type="edit" name="zip" value="" 
			...
			echo '	<br>
					...
					<form name="basic" method="POST" action="table08.php">
						...
						<table class="table table-condensed" 
							...
							<h2>Bicycle Information Form</h2></td></tr>
							...
							<tr><td>zip: </td><td><input type="edit" 
...

{
    ...
    if($stmt = $mysqli->prepare("INSERT INTO $usertable (type,zip,model,color,
...

    {
        ...
        $stmt->bind_param('ssssssi', $name, $zip, $model, $color, $wheel, 
...

{
    ...
    if($stmt = $mysqli->prepare("UPDATE $usertable SET type = ?, zip = ?, 
