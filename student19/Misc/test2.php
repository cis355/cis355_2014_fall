...
function showForm()
{
    return "<!DOCTYPE html><html>
        ...
        <form name='basic' method='Post' action='test2.php' onSubmit='return validate();'>
...
{
    echo "<br><form name='basic' method='Post' action='test2.php' onSubmit='return validate();'>
