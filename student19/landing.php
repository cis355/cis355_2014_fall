<?php
    ...
    ini_set("session.cookie_domain", ".cis355ticket.webuda.com");
	...
	if(isset($_POST['loginSubmit']))
	{
		...
		$username="a6960133_nate";
		$password="uzbnsjd9";
		$dbname="a6960133_ticket";
		...
		// Create query
		$sql = "SELECT user_id FROM users WHERE user_name = ? AND user_pass = ?";
