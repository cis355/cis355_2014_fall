...
// Prints all items in column:name in table:table01123 of database:lesson01

// And adds random entry to table:table01123
...
if($result) { // if $result is empty there is no output and no message
  ...
  # INSERT INTO `lesson01`.`table01123` (`id`, `name`, `desc`) VALUES (NULL, 'delta', 'fourth');
