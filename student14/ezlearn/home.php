...
include "functions.php";
	...
	function PostAnnouncement()
	{
		...
		if(!empty($_GET))
		{
			...
			$result = GetRecordsWhere($mysqli, "*", "zmm_announcements", "announcement_id", $id);
			
		}
		else
		{
			$result = GetRecords($mysqli, "*", "zmm_announcements ORDER BY announcement_id DESC LIMIT 1");
		}
...
?>
				...
				?>
					...
					<div class="panel panel-default">
						...
						<?php 
							$mysqli = ConnectToDb("ezlearn");
							$result = GetRecords($mysqli, "*", "zmm_announcements ORDER BY announcement_id DESC");
