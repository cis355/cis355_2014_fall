...
<div class="col-lg-9">
	...
	<table class="table table-bordered table-striped">
		...
		<?php
			...
			// Get the admins
			$result = GetRecordsWhere($mysqli, "*","zmm_students","admin","1");
...
<div class="col-lg-3">	<?php		if ($_SESSION['admin'] == 1)		{		
...
<script>
	...
	// Show the validation for deletion
	...
	// Populate the modal with the students information
