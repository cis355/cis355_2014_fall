<?php
	...
	{
		$connect = new mysqli("localhost", "zmmetiva", "cool_beans", $database);
	...
	{
		$sql = "INSERT INTO students (fname, lname, username, password, admin ) VALUES (? ,?, ?, ?, ?)";
	...
	{
		$sql = "UPDATE students SET fname = ?, lname = ?, username = ?, password = ?, admin = ? WHERE student_id = ?";
		$statement = $mysqli->stmt_init();
	...
	{
		$sql = "UPDATE announcements SET title = ?, text = ? WHERE announcement_id = ?";
		$statement = $mysqli->stmt_init();
	...
	{
		$sql = "INSERT INTO announcements (title, text, date) VALUES (?, ?, ?)";
		$statement = $mysqli->stmt_init();
	...
	function InsertAssignment($mysqli, $heading, $title, $text, $dateDue, $datePosted)
	{
		$sql = "INSERT INTO assignments (heading, title, text, dateDue, datePosted) VALUES (?, ?, ?, ?, ?)";
		$statement = $mysqli->stmt_init();
		
		if($statement = $mysqli->prepare($sql))
		{
			$statement->bind_param('sssss', $heading, $title, $text, $dateDue, $datePosted);
			if($statement->execute())
			$statement->close();
	...
	{
		$sql = "UPDATE assignments SET title = ?, text = ?, dateDue = ? WHERE assignment_id = ?";
		$statement = $mysqli->stmt_init();
							...
							<div class="navbar-default sidebar" role="navigation">
								<div class="sidebar-nav navbar-collapse">
									<ul class="nav" id="side-menu">
										...
										<li>
											<a href="#"><i class="fa fa-list-alt fa-fw"></i> Grades</a>
										</li>
										<li>
