		...
		<div class="panel panel-default" style="box-shadow: 2px 2px 7px #888888;">
			<div class="panel-heading"><b>Account Information</b></div>
				...
				<table class="table borderless">
					...
					<tr><td><b>Location ID: </td><td> <?php echo $_SESSION['location']; ?></td></tr>
					<tr><td><b>Location Name: </td><td><?php echo GetStrLocation($mysqli); ?></td></tr>
				</table>
				</div>
		</div>
	</div>
...
<?php 
$mysqli->close();
function GetStrLocation($mysqli)
{
