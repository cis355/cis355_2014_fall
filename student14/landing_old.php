...
<?php
	...
	function GetItems()
	{
		...
		//$items = array("Video Games", "Guitars", "Compund Bows", "Power Tools", "Books", "Video Games", "Bicycles", "Vehicles", "Jet Skis", 
		...
		while ( $tableIndex < 23)
		{
			...
			if ($tableIndex < 9)
				$column = "<td><a href='http://www.cis355.com/student0" . ($tableIndex+1) . "/table0". ($tableIndex+1) .".php'>" . "Table 0" . ($tableIndex+1). "</a></td>";
			
			// Otherwise, insert the respective number
			else
				$column = "<td><a href='http://www.cis355.com/student" . ($tableIndex+1) . "/table". ($tableIndex+1) .".php'>" . "Table " . ($tableIndex+1) . "</a></td>";
