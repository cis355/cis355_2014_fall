 ...
 * Post:    the connection has been confirmed.
 * 
...
function insertRecord($mysqli)
{
    ...
    if($stmt = $mysqli->prepare("INSERT INTO $usertable (name,description) VALUES (?, ?)"))
    {
...
function updateRecord($mysqli)
{
    ...
    $sql = "UPDATE $usertable SET description='updated!' WHERE name=?";
...
function showForm()
{
    return "<!DOCTYPE html><html>
        <head><title>Form</title></head><body><style>
        ...
        <form name='basic' method='Post' action='form.php' onSubmit='return validate();'>
        <table border=0 cellpadding=5 cellspacing=0>
        <tr><td>name</td><td><input type='edit' name='name' value='' size=20></td></tr>
        <tr><td>desc</td><td><input type='edit' name='descript' value='' size=30></td></tr>
...
{
    echo "<br><form name='basic' method='Post' action='form.php' onSubmit='return validate();'>
