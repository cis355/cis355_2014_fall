...
function showInsertForm($mysqli)
{
	...
	<form name="basic" method="POST" action="table09.php" onSubmit="return validate();">
		<table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
			...
			<tr><td>User: </td><td>'. $_SESSION["user"] .'</td></tr>
			<tr><td>Location: </td><td>'. $_SESSION["location"] .'</td></tr>
			...
			echo '	<br>
					...
					<form name="basic" method="POST" action="table09.php">
						<table class="table table-condensed" style="border: 1px solid #dddddd; border-radius: 5px; box-shadow: 2px 2px 10px;">
							...
							<tr><td>User: </td><td><input type="edit" name="user_id" value="'. $_SESSION["user"] .'" size="20"></td></tr>
							<tr><td>Location: </td><td><input type="edit" name="location_id" value="' . $_SESSION["location"] . '" size="20"></td></tr>
