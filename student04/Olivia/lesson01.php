...
// Prints all items in column:name in table:table04 of database:lesson01

// And adds random entry to table:table04
...
if($result) { // if $result is empty there is no output and no message
  ...
  # INSERT INTO `lesson01`.`table04` (`id`, `name`, `descrip`) VALUES (NULL, 'delta', 'fourth');

  $query = "INSERT INTO `lesson01`.`table04` (`id`, `name`, `descrip`) VALUES (NULL, '$val1', '$val2')";
