...
function showList($mysqli, $msg) 
{
	...
	echo "You are logged in as user: ".$_SESSION["user"]." (".$_SESSION["id"].") ".
	    ", default location: ".$_SESSION["location"]."<br>";
	...
	echo 	'<div class="col-md-12">
			...
			<h2 style="color: white;">House Insurance Prices (Table 01)</h2>
			</td></tr><tr style="font-weight:800; font-size:20px;">
			<td>ID</td><td>Type:</td><td>InsCo:</td>
			<td>Agency:</td><td>SqFt:</td><td>Zip Code:</td>
			<td>HousePrice:</td><td>InsPerYear:</td>						
	...
	echo		'</form></div>';
	echo '<br><a href="http://cis355.com/student01/bionotes.html">Author Bio and Program Notes</a>';
	...
	<form name="basic" method="POST" action="table01.php" 
		...
		<table class="table table-condensed" style="border: 1px solid #dddddd; 
			...
			<tr><td colspan="2" style="text-align: center; border-radius: 5px; 
			    color: white; background-color:#333333;">
			<h2>Entry Form</h2></td></tr>
			<tr><td>Type: </td><td><input type="edit" name="type" value="" 
			size="20"></td></tr>
			<tr><td>InsCo: </td><td><input type="edit" name="brand" value="" 
			size="20"></td></tr>
			<tr><td>Agency: </td><td><input type="edit" name="model" value="" 
			size="30"></td></tr>
			<tr><td>SqFt: </td><td><input type="edit" name="color" value="" 
			size="20"></td></tr>
			<tr><td>Zip Code: </td><td><input type="edit" name="strWind" 
			value="" size="30"></td></tr>
			<tr><td>HousePrice: </td><td><input type="edit" name="price" value="" 
			size="20"></td></tr>
			<tr><td>InsPerYear: </td><td><textarea style="resize: none;" 
