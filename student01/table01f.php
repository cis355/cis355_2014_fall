...
{   //gpc: form info edited below
	...
	<tr><td width=\"35%\">interior</td><td>$interior</td></tr>
...
function showForm()
{
    return "<!DOCTYPE html><html>
		...
		<body>
        <form name='basic' method='Post' action='table01f.php' onSubmit='return validate();'>
        ...
        <tr><td>interior</td><td><input type='edit' name='interior' value='' size=20></td></tr>
...
{
    echo "<br><form name='basic' method='Post' action='table01f.php' onSubmit='return validate();'>
...
function createTable($mysqli)
{
	...
	echo "usertable is: ".$usertable."<br>";
	
	echo "result1 is: ".$result."<br>";
	echo "now testing if there is a record in the database...<br>";
	
    /* test select via object */
    if($result = $mysqli->query("select * from $usertable limit 1"))
    {
	    echo "result2 is: ".$result."<br>";
    ...
    if(!$id)
    {
		...
		{
		    echo "Whoa. Could not create table!<br>";
			echo "CREATE TABLE sql statmement was: <br>".$sql."<br>";
		}
    }
    else 
	{
